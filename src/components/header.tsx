    ...
    return (
        <div className='bg-[#9c9c9c]'>
            ...
            <div className='bg-white border border-[#1E3A8A] rounded-[22px] flex justify-center items-center text-[#1E1E1E]'>
                ...
                />
                <button className='bg-[#1E3A8A] px-2 py-2 rounded-r-[22px]'>
        ...
        <div className='flex flex-col w-full'>
            <div className='relative'>
                ...
                <div className='absolute w-full z-20 text-white flex justify-between px-2 md:px-10 lg:px-20 py-2 font-semibold'>
                    <h1 className='text-3xl tracking-wider'>Aspire<span className='text-[#1E3A8A]'>TECH</span></h1>
            ...
            <div className='md:mt-56 lg:mt-72 xl:mt-64 2xl:mt-[16rem] md:flex justify-between md:px-10 lg:px-20 hidden'>
